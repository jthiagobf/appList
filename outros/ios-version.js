...
export default function App() {
  ...
  async function addTask(){
    ...
    if (newTask === ''){
     Alert.alert('Amor', 'pra quê adicionar lembretes vazios? Que palhaçada!');
     return;
   }
   
    const search = task.filter(task => task === newTask);
   if (search.length != 0){
Alert.alert('Amor!', 'você já adicionou essa tarefa');
return
   }
  ...
  return (
   ...
   <KeyboardAvoidingView
    ...
    <View style={styles.container}>
      ...
      <Text>Olá, amor! fiz esse app pra você sempre lembrar dos seus afazeres. Te amo!</Text>
